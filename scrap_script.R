...
reach_state <- svy_targets %>% 
  ...
  summarise(reach_rice_combined = survey_mean(rice_combined == "Yes"),
            ...
            inadequate_MN2 = survey_mean(risk_MND == "Yes", na.rm = TRUE),
            inadequate_MN3 = survey_mean(risk_MND3 == "Yes", na.rm = TRUE))

reach_state <- reach_state %>% 
  dplyr::select(state, reach_rice_combined, reach_wheatf, reach_maizef, 
                inadequate_MN2, inadequate_MN3)
...
# Map proportion of households with inadequte intake of >= 2 MN's in each LGA: 

inadequate_MN2 <- tm_shape(nigeria2_reach) + 
  tm_fill(col = "inadequate_MN2", breaks = breaks, palette = "Blues",
          colorNA = "gray35",
          labels = c("0", "0-30%", "30-60%", "60-80%", "80-100%")) +
  tm_layout(main.title = "Inadequate intake of >= 2 Micronutrients", frame = F,
            main.title.size = 0.8) +
  tm_borders(col = "black", lwd = 0.7) +
  tm_legend(show = F)
...
inadequate_MN3 <- tm_shape(nigeria2_reach) + 
  tm_fill(col = "inadequate_MN3", breaks = breaks, palette = "Blues",
          colorNA = "gray35",
          labels = c("0", "0-30%", "30-60%", "60-80%", "80-100%")) +
  tm_layout(main.title = "Inadequate intake of >= 3 Micronutrients", frame = F,
            main.title.size = 0.8) +
  tm_borders(col = "black", lwd = 0.7) +
  tm_legend(show = F)
...
# legend: 
mn_legend <- tm_shape(nigeria2_reach) + 
  tm_fill(col = "inadequate_MN2", breaks = breaks, palette = "Blues",
          title = "% of households",
          labels = c("0", "0-30%", "30-60%", "60-80%", "80-100%"),
          textNA = "Missing Data",
...
mn_adm2 <- list(inadequate_MN2, inadequate_MN3, mn_legend)

mn_adm2 <- tmap_arrange(mn_adm2, ncol = 3, sync = TRUE)

mn_adm2

tmap_save(mn_adm2, "figures/targets/mn_adm2.jpeg", height = 3.5, width = 8, dpi = 600)

#-------------------------------------------------------------------------------

# ADM1:

inadequate_MN2 <- tm_shape(nigeria1_reach) + 
  tm_fill(col = "inadequate_MN2", breaks = breaks, palette = "Blues",
          colorNA = "gray35",
          labels = c("0", "0-30%", "30-60%", "60-80%", "80-100%")) +
  tm_layout(main.title = "Inadequate intake of >= 2 Micronutrients", frame = F,
...
inadequate_MN3 <- tm_shape(nigeria1_reach) + 
  tm_fill(col = "inadequate_MN3", breaks = breaks, palette = "Blues",
          colorNA = "gray35",
          labels = c("0", "0-30%", "30-60%", "60-80%", "80-100%")) +
  tm_layout(main.title = "Inadequate intake of >= 3 Micronutrients", frame = F,
...
# legend: 
mn_legend <- tm_shape(nigeria1_reach) + 
  tm_fill(col = "inadequate_MN2", breaks = breaks, palette = "Blues",
          title = "% of households",
          labels = c("0", "0-30%", "30-60%", "60-80%", "80-100%"),
          textNA = "Missing Data",
...
mn_adm1 <- list(inadequate_MN2, inadequate_MN3, mn_legend)

mn_adm1 <- tmap_arrange(mn_adm1, ncol = 3, sync = TRUE)

mn_adm1

tmap_save(mn_adm1, "figures/targets/mn_adm1.jpeg", height = 3.5, width = 8, dpi = 600)
...
# Map risk of >= 2 inadequate micronutrients: 
